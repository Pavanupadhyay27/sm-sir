...
export default function Teaching() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative">
      ...
      <div className="space-y-8 mb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {courses.map((course) => (
            <div
              key={course.code}
              className="glass p-8 rounded-3xl border border-custom-border hover:border-primary-emerald/20 transition-all duration-300 flex flex-col justify-between"
            >
              <div className="space-y-4">
                ...
                <h3 className="font-heading text-base font-bold text-custom-fg">
                  {course.title}
                </h3>
                ...
                <ul className="grid grid-cols-2 gap-1.5 text-[9px] font-mono text-custom-fg">
                  {course.topics.map((t, idx) => (
                    <li key={idx} className="flex items-center space-x-1">
                      <span className="w-1 h-1 rounded-full bg-primary-emerald" />
      ...
      {/* Social Education Outreach Timeline */}
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {p.outreach.map((out) => (
            <div
              key={out.id}
              className="glass p-8 rounded-3xl border border-custom-border hover:border-accent-gold/25 glow-gold-hover transition-all duration-300 flex flex-col justify-between"
            >
              <div className="space-y-4">
