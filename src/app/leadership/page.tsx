...
export default function Leadership() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative">
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-4 space-y-4">
                <div className="w-12 h-12 rounded-2xl bg-primary-emerald/8 border border-primary-emerald/20 flex items-center justify-center">
                  {icons[adm.id] || <Briefcase className="w-6 h-6 text-primary-emerald" />}
                </div>
                <div>
                  <h3 className="font-heading text-lg font-bold text-custom-fg leading-tight">{adm.role}</h3>
              ...
              <div className="lg:col-span-8 space-y-6 lg:border-l lg:border-custom-border/50 lg:pl-8">
                <div className="space-y-2">
                  ...
                  <p className="text-xs sm:text-sm text-custom-muted leading-relaxed">{adm.description}</p>
                </div>
                ...
                <div className="bg-primary-emerald/5 border border-primary-emerald/20 rounded-2xl p-5 relative overflow-hidden">
                  ...
                  <p className="text-xs font-semibold text-custom-fg leading-relaxed">{adm.impact}</p>
                </div>
              </div>
            </div>
          </TiltCard>
      ...
      {/* Animal Welfare */}
      <TiltCard intensity={5} className="glass p-8 rounded-3xl max-w-4xl mx-auto shimmer-border">
        <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-primary-emerald/30 to-transparent rounded-t-3xl" />
